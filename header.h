...
int loadflag=0;//Flag to know if program is already loaded or not
...
void inputchecker(int *choice)   // Checks if input is digit (neither letters nor symbols)
{
    int i,m=0,flag=1;
